...
},{"coordinates":8,"ea":9}],3:[function(require,module,exports){
/*!
...
exports["default"] = function (pointer) {
  var origin = arguments.length <= 1 || arguments[1] === undefined ? { x: 0, y: 0 } : arguments[1];

  var x = pointer.x - origin.x;
  var y = pointer.y - origin.y;
  var r = Math.sqrt(Math.pow(x, 2) + Math.pow(y, 2));
  var fi = Math.atan(x === 0 ? Infinity : y / x) + (x < 0 ? Math.PI : y < 0 ? 2 * Math.PI : 0);
